...
const PrivacyPolicy = () => {
  return (
    <div className="privacy-policy__wrap">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Electronic Store.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Electronic Store, accessible from{" "}
            <a
              href="https://test-9b5eb.web.app/"
      ...
      <ul>
        ...
        <li>
          ...
          used for Browser Cookies. For e information on how You can delete
      ...
      <ul>
        <li>By email: mielkadosh7@gmail.com</li>
      </ul>
    </div>
  );
};
